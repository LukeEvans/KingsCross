...
class NewsBootstrap extends Actor with ActorLogging {
  ...
  def general() {
    ...
    val atlanticID = "atlantic"
    val atlantic = context.actorOf(Props(classOf[AtlanticNews], new NewsConfig(id=atlanticID,url="http://feeds.feedburner.com/TheAtlantic?format=xml",emitPlatform="/news/"+atlanticID,collectPlatform="/news/"+atlanticID,pollTime=standardPollTime)))
    ...
    val cnnPoliticsID = "cnn_politics"
    val cnnPolitics = context.actorOf(Props(classOf[CNNPoliticsNews], new NewsConfig(id=cnnPoliticsID,url="http://rss.cnn.com/rss/cnn_allpolitics.rss",emitPlatform="/news/"+cnnPoliticsID,collectPlatform="/news/"+cnnPoliticsID,pollTime=standardPollTime)))
    ...
    val nhlID = "nhlfeatured"
    val nhl = context.actorOf(Props(classOf[NhlNews], new NewsConfig(id=nhlID,url="http://www.nhl.com/rss/features.xml",emitPlatform = "/news/"+nhlID,collectPlatform = "/news/"+nhlID,pollTime = standardPollTime)))

    val nprBusinessID = "npr_business"
    ...
    val nprEntertainmentID = "npr_entertainment"
    ...
    val nprPoliticsID = "npr_politics"
    ...
    val wsjID = "wsj"
    val wsj = context.actorOf(Props(classOf[WallStreetJournalNews], new NewsConfig(id=wsjID,url="http://online.wsj.com/xml/rss/3_7014.xml",emitPlatform="/news/"+wsjID,collectPlatform="/news/"+wsjID,pollTime=standardPollTime)))
